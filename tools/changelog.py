...
RELEASE_TAG_BASE_URL = 'https://github.com/kostaond/esp-eth-drivers/commits/' # TODO change to espressif
...
def create_release_notes(component:str, release_notes:str) -> None:
    ...
    # store release notes to a temp file to be used later in the release process
